...
(function(vue, shared) {
  ...
  const _imports_0 = "/static/muyu.jpg";
  var isVue2 = false;
...
This will fail in production if not fixed.`);
  ...
  const useUserStore = defineStore(
    ...
    () => {
      ...
      const userinfo = vue.ref(persistUserinfo());
      ...
      const authToken = vue.ref(persistToken());
  ...
  const interceptorConfig = {
    invoke(args) {
      ...
      const token = (_a = useUserStore().userinfo) == null ? void 0 : _a.token;
      if (token)
  ...
  const _sfc_main$9 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const syncData = async () => {
        ...
        formatAppLog("log", "at pages/index/index.vue:31", res.data);
        userStore.updateUserinfo({
          ...userStore.userinfo,
          ...res.data
        });
        formatAppLog("log", "at pages/index/index.vue:36", userStore.userinfo);
      };
      const syncDataPostGongde = async () => {
        ...
        formatAppLog("log", "at pages/index/index.vue:48", res);
      };
      const userStore = useUserStore();
      var animating = false;
      const tips_isVisible = vue.ref(false);
      ...
      const animation1Data = vue.ref();
      const animation1 = uni.createAnimation({
        duration: 60
      });
      const animation2Data = vue.ref();
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock(
          ...
          null,
          [
            vue.unref(userStore).authToken ? (vue.openBlock(), vue.createElementBlock(
              "view",
              {
                key: 0,
                class: "total-gongde-display"
              },
              " 总功德: " + vue.toDisplayString((_a = vue.unref(userStore).userinfo) == null ? void 0 : _a.total_gongde),
              1
              /* TEXT */
            )) : vue.createCommentVNode("v-if", true),
            vue.createElementVNode(
              "view",
              { class: "gongde-display" },
              " 本次功德: " + vue.toDisplayString(vue.unref(userStore).curGongde),
              1
              /* TEXT */
            ),
            vue.createElementVNode("view", { class: "container" }, [
              vue.createElementVNode("view", {
                ...
                vue.createElementVNode(
                  ...
                  [
                    vue.withDirectives(vue.createElementVNode("view", {
                      class: "tips-content",
                      animation: animation2Data.value
                    }, " 功德+" + vue.toDisplayString(((_c = (_b = vue.unref(userStore)) == null ? void 0 : _b.globalStaticSettings) == null ? void 0 : _c.gongdePerCount) || 1), 9, ["animation"]), [
                      [vue.vShow, tips_isVisible.value]
                    ])
                  ],
                  512
                  /* NEED_PATCH */
                ...
                vue.createElementVNode("image", {
                  animation: animation1Data.value,
                  src: _imports_0,
                  class: "muyu"
                }, null, 8, ["animation"])
              ])
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__file", "D:/HXPrj/muyuPrj/pages/index/index.vue"]]);
  const icons = {
    "id": "2852637",
    "name": "uniui图标库",
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$4], ["__scopeId", "data-v-d31e1c47"], ["__file", "D:/HXPrj/muyuPrj/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  const toLogin = async () => {
    uni.navigateTo({
      url: "/pages/login/login"
    });
  ...
  const _sfc_main$7 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const syncDataPostGongdeClear = async () => {
        ...
        formatAppLog("log", "at pages/my/my.vue:53", res);
      };
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock(
          ...
          [
            vue.createElementVNode("view", { class: "info-box" }, [
              vue.createElementVNode("view", { class: "info-box-title" }, " 用户名 "),
              vue.createElementVNode("view", { class: "info-box-content" }, [
                vue.unref(userStore).authToken ? (vue.openBlock(), vue.createElementBlock(
                  "view",
                  { key: 0 },
                  vue.toDisplayString(vue.unref(userStore).userinfo.username),
                  1
                  /* TEXT */
                )) : (vue.openBlock(), vue.createElementBlock("view", {
                  key: 1,
                  style: { "font-size": "4vw", "color": "lightslategray" },
            ...
            vue.createElementVNode("view", { class: "info-box" }, [
              vue.createElementVNode("view", { class: "info-box-title" }, " 总功德 "),
              vue.createElementVNode("view", { class: "info-box-content" }, [
                vue.unref(userStore).authToken ? (vue.openBlock(), vue.createElementBlock(
                  "view",
                  { key: 0 },
                  vue.toDisplayString(vue.unref(userStore).userinfo.total_gongde),
                  1
                  /* TEXT */
                )) : (vue.openBlock(), vue.createElementBlock("view", {
                  key: 1,
            ...
            vue.createElementVNode("view", { class: "info-box" }, [
              vue.createElementVNode("view", { class: "info-box-title" }, " 本次功德 "),
              vue.createElementVNode("view", { class: "info-box-content" }, [
                vue.createElementVNode(
                  "view",
                  null,
                  vue.toDisplayString(vue.unref(userStore).curGongde),
                  1
                  /* TEXT */
                )
              ])
            ]),
            vue.createElementVNode("view", { class: "info-div" }),
            vue.unref(userStore).authToken ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 0,
              class: "info-box-single",
              onClick: Logout
            }, [
              vue.createElementVNode("view", { class: "info-box-title" }, " 退出登录 "),
            ...
            vue.unref(userStore).authToken ? (vue.openBlock(), vue.createElementBlock("view", {
              ...
              vue.createElementVNode("view", { class: "info-box-title" }, " 清空总功德 "),
              vue.createVNode(_component_uni_icons, {
                type: "right",
                size: "20",
                color: "#fff"
  ...
  const PagesMyMy = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__file", "D:/HXPrj/muyuPrj/pages/my/my.vue"]]);
  const _sfc_main$6 = {
    name: "UniNumberBox",
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$3], ["__scopeId", "data-v-7ae2ee72"], ["__file", "D:/HXPrj/muyuPrj/uni_modules/uni-number-box/components/uni-number-box/uni-number-box.vue"]]);
  const _sfc_main$5 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const syncDataPostSettings = async () => {
        ...
        formatAppLog("log", "at pages/settings/settings.vue:24", res);
      };
      const userStore = useUserStore();
      const dealBindSwitch = (e) => dynamicSettings.value.autoMuYu = e.detail.value;
      const dynamicSettings = vue.ref(userStore.globalStaticSettings || {
        gongdePerCount: 1,
        autoMuYu: false,
        autoMuYuFrequency: 1
      });
      ...
      return (_ctx, _cache) => {
        const _component_uni_number_box = resolveEasycom(vue.resolveDynamicComponent("uni-number-box"), __easycom_0$1);
        return vue.openBlock(), vue.createElementBlock(
          vue.Fragment,
          null,
          [
            vue.createElementVNode("view", { class: "info-box-settings" }, [
              vue.createElementVNode("view", { class: "info-box-title" }, " 单次功德数 "),
              vue.unref(userStore).authToken ? (vue.openBlock(), vue.createElementBlock("view", { key: 0 }, [
                vue.createVNode(_component_uni_number_box, {
                  onChange: dealSettingsChange,
                  modelValue: dynamicSettings.value.gongdePerCount,
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => dynamicSettings.value.gongdePerCount = $event),
                  background: "#ddb05c",
                  disabled: false,
                  min: 1,
                  max: 999,
            ...
            vue.createElementVNode("view", { class: "info-box" }, [
              vue.createElementVNode("view", { class: "info-box-title" }, " 自动木鱼 "),
              vue.unref(userStore).authToken ? (vue.openBlock(), vue.createElementBlock("view", { key: 0 }, [
                vue.createElementVNode("view", { class: "info-box-content" }, [
                  vue.createElementVNode("view", null, " 开启 "),
                  vue.createElementVNode("switch", {
                    onChange: _cache[2] || (_cache[2] = (e) => {
                      dealBindSwitch(e);
                      dealSettingsChange();
                    }),
                    color: "#ddb05c",
                    disabled: false,
                    checked: dynamicSettings.value.autoMuYu
                  }, null, 40, ["checked"])
                ]),
                vue.createElementVNode("view", { class: "info-box-content" }, [
                  vue.createElementVNode("view", null, " 自动木鱼时间间隔(秒) "),
                  vue.createVNode(_component_uni_number_box, {
                    onChange: dealSettingsChange,
                    background: "#ddb05c",
                    disabled: false,
                    ...
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => dynamicSettings.value.autoMuYuFrequency = $event)
                  }, null, 8, ["min", "step", "modelValue"])
                ])
              ])) : (vue.openBlock(), vue.createElementBlock("view", {
                key: 1,
                style: { "font-size": "4vw", "color": "lightslategray" },
  ...
  const PagesSettingsSettings = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__file", "D:/HXPrj/muyuPrj/pages/settings/settings.vue"]]);
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$2], ["__scopeId", "data-v-09fd5285"], ["__file", "D:/HXPrj/muyuPrj/uni_modules/uni-easyinput/components/uni-easyinput/uni-easyinput.vue"]]);
  const _sfc_main$3 = {
    name: "uniFormsItem",
    options: {
      virtualHost: true
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$1], ["__scopeId", "data-v-462874dd"], ["__file", "D:/HXPrj/muyuPrj/uni_modules/uni-forms/components/uni-forms-item/uni-forms-item.vue"]]);
  var pattern = {
    email: /^\S+?@\S+?\.\S+?$/,
  ...
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render], ["__scopeId", "data-v-9a1e3c32"], ["__file", "D:/HXPrj/muyuPrj/uni_modules/uni-forms/components/uni-forms/uni-forms.vue"]]);
  const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const submitForm = async () => {
        try {
          ...
          if (isRegisterMode.value) {
            ...
            formatAppLog("log", "at pages/login/login.vue:63", res);
            uni.showToast({
              title: res.msg,
              icon: "success",
              mask: true
            ...
            formatAppLog("log", "at pages/login/login.vue:84", res);
            uni.showToast({
              title: res.msg,
              icon: "success",
              mask: true
      ...
      const isRegisterMode = vue.ref(false);
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock(
          ...
          [
            ...
            vue.createElementVNode("view", { class: "page-title" }, " 云木鱼 "),
            vue.createElementVNode("view", { class: "form-background" }, [
              vue.createVNode(_component_uni_forms, {
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(_component_uni_forms_item, {
                    name: "username",
                    class: "forms-sub-item"
                  }, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode("text", {
                        class: "label",
                        style: { "min-width": "1vw", "color": "#fff", "margin-bottom": "1vw" }
                      }, "用户名"),
                  ...
                  vue.withDirectives(vue.createElementVNode(
                    ...
                    [vue.vShow, isRegisterMode.value]
                  ])
                ]),
                _: 1
                /* STABLE */
              }, 8, ["model"]),
              vue.createElementVNode("view", { class: "modeSwitch" }, [
                vue.createElementVNode(
                  "text",
                  { onClick: dealModeSwitch },
                  vue.toDisplayString(isRegisterMode.value ? "已注册? 去登录" : "尚无账号? 去注册"),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode(
                "button",
                { onClick: submitForm },
                vue.toDisplayString(isRegisterMode.value ? "注册" : "登录"),
                1
                /* TEXT */
              )
            ])
  ...
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "D:/HXPrj/muyuPrj/pages/login/login.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/HXPrj/muyuPrj/App.vue"]]);
  function createApp() {
